...
void fire_cannon(unsigned int cannon_num, unsigned int ammo_count,
                 unsigned int delay, unsigned int print_wait_interval,
                 char *print_wait_interval_format_specifier);
void
fire_first_cannon(unsigned int ammo_count)
{
	fire_cannon(1, ammo_count, 6000, 2000, "%.0f sec. passed\n");
}
void
fire_second_cannon(unsigned int ammo_count)
{
	fire_cannon(2, ammo_count, 600, 200, "%.1f sec. passed\n");
}
...
void
fire_cannon(unsigned int cannon_num, unsigned int ammo_count,
            unsigned int delay_ms, unsigned int print_wait_interval_ms,
            char *print_wait_interval_format_specifier)
{
	int round_current = 0;
	double time_delta;
